/******************************************************************************
 * @file     vio_STM32F407G-DISC1.c
 * @brief    Virtual I/O implementation for board STM32F407G-DISC1
 * @version  V1.0.0
 * @date     4. October 2024
 ******************************************************************************/
/*
...
/*! \page vio_STM32F407G-DISC1 Physical I/O Mapping
...
| vioLED0       | vioSignalOut.0 | LED red     (LD5)    | PD14
| vioLED1       | vioSignalOut.1 | LED green   (LD4)    | PD12
| vioLED2       | vioSignalOut.2 | LED blue    (LD6)    | PD15
| vioLED3       | vioSignalOut.3 | LED orange  (LD3)    | PD13
*/
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTD(14), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED1,    GPIO_PIN_ID_PORTD(12), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED2,    GPIO_PIN_ID_PORTD(15), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED3,    GPIO_PIN_ID_PORTD(13), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH }
};
#endif
